...
/**
 * Pawkit DropdownMenu (shadcn-style, Radix UI under the hood).
 * For overflow menus, language pickers, settings sub-menus.
 */
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-md border border-ink/10 bg-popover p-1 text-popover-foreground shadow-lg",
      className
    )}
    {...props}
  />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-md border border-ink/10 bg-popover p-1 text-popover-foreground shadow-md",
